        ...
        <div class="alert alert-info alert-soft mb-6">
          ...
          <div>
            ...
            <div class="text-sm mt-1">
              ...
              <p><strong>ISBN:</strong> International Standard Book Number (optional, 10 or 13 digits)</p>
            </div>
          </div>
        </div>
                  ...
                  <tr>
                    <th class="text-base-content font-semibold">
                      <div class="flex flex-col">
                        <span>Title</span>
                        <span class="text-xs font-normal text-base-content/60">Book title (required)</span>
                      </div>
                    </th>
                    <th class="text-base-content font-semibold">
                      <div class="flex flex-col">
                        <span>Author</span>
                        <span class="text-xs font-normal text-base-content/60">Author(s) name (required)</span>
                      </div>
                    </th>
                    <th class="text-base-content font-semibold">
                      <div class="flex flex-col">
                        <span>ISBN</span>
                        <span class="text-xs font-normal text-base-content/60">10 or 13 digit ISBN (optional)</span>
                      </div>
                    </th>
